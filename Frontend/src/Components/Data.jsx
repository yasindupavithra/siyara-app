...
export const products = [
  {
    ...
    price: 113999,
    brand: "CasaCraft",
    description: "Premium half leather sofa with elegant grey finish",
    category: "Sofas",
    ratings: 4.5,
    numOfRatings: 128,
    Stock: 15
  },
  {
    ...
    price: 28999,
    brand: "CasaCraft",
    description: "Compact 2-seater sofa perfect for small spaces",
    category: "Sofas",
    ratings: 4.2,
    numOfRatings: 89,
    Stock: 12
  },
  {
    ...
    price: 49999,
    brand: "Woodsworth",
    description: "Elegant navy blue sofa with premium fabric",
    category: "Sofas",
    ratings: 4.7,
    numOfRatings: 156,
    Stock: 8
  },
  {
    ...
    price: 53999,
    brand: "CasaCraft",
    description: "Fresh mint green sofa for modern living rooms",
    category: "Sofas",
    ratings: 4.3,
    numOfRatings: 94,
    Stock: 10
  },
  {
    ...
    price: 26999,
    brand: "CasaCraft",
    description: "Sophisticated ash grey sofa with premium comfort",
    category: "Sofas",
    ratings: 4.6,
    numOfRatings: 112,
    Stock: 14
  },
  {
    ...
    price: 53999,
    brand: "CasaCraft",
    description: "Warm rust colored sofa for cozy living spaces",
    category: "Sofas",
    ratings: 4.4,
    numOfRatings: 78,
    Stock: 6
  },
  {
    ...
    price: 47999,
    brand: "CasaCraft",
    description: "Luxurious velvet blue sofa for elegant interiors",
    category: "Sofas",
    ratings: 4.8,
    numOfRatings: 203,
    Stock: 9
  },
  {
    ...
    price: 14999,
    brand: "Bohemiana",
    description: "Elegant metal settee with grey upholstery",
    category: "Settees",
    ratings: 4.1,
    numOfRatings: 45,
    Stock: 7
  },
  {
    ...
    price: 17499,
    brand: "Bohemiana",
    description: "Solid wood settee with rich brown finish",
    category: "Settees",
    ratings: 4.5,
    numOfRatings: 67,
    Stock: 11
  ...
  },
  {
    ...
    offer_price: 14299,
    actual_price: 16999,
    total_savings: "2,700 (16% Off)",
    price: 14299,
    brand: "Adiko Systems",
    description: "Modern gaming chair with ergonomic design",
    category: "Chairs",
    ratings: 4.6,
    numOfRatings: 189,
    Stock: 18
...
// Function to get all products including custom ones
export const getAllProducts = () => {
  const customProducts = JSON.parse(localStorage.getItem('customProducts') || '[]');
  return [...products, ...customProducts];
};

// API Response Format for Redux Compatibility
export const getProductsResponse = {
  products: getAllProducts(),
  productsCount: getAllProducts().length,
  resultPerPage: 8,
  filteredProductsCount: getAllProducts().length
};
...
export const filterProducts = (price, brand) => {
